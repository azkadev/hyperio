...
// import 'package:hyperio/core/io/core/route_matcher.dart';
// import 'package:hyperio/core/io/io.dart';

import 'dart:io' show ContentType;

// import 'package:hyperio/core/core.dart';
import 'package:hyperio/core/body_parser/http_body.dart';
...
import 'package:hyperio/core/hyperio.dart';

/// Some convenience methods on the [HttpRequest] object to make the api
/// more like ExpressJS
///
extension RequestHelpers on HyperioAzkadevHttpRequest {
  ...
  /// Get HyperioAzkadevNative instance which is associated with this request
  ///
  HyperioAzkadev get hyperio => store.get<HyperioAzkadev>('_internal_hyperio');
}
