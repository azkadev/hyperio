...
import 'package:hyperio/package/mime_type/mime_type.dart';

import 'file_helpers.dart';

/// A set of extensions on the [HttpResponse] object, mostly for convenience
///
extension ResponseHelpers on HyperioAzkadevHttpResponse {
  ...
  ///
  FutureOr<dynamic> json(Object? value) async {
    headers.contentType = ContentType.json;
    write(convert.json.encode(value));
    return await close();
  }

  /// HyperioAzkadevUncompleteDocumentation
  HyperioAzkadevHttpResponse status(int value) {
    statusCode = value;
    return this;
  }
