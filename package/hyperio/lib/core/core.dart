...
import 'package:hyperio/event_emitter/event_emitter.dart' show EventEmitterAzkadevAzkadev, EventEmitterAzkadevListenerAzkadev;

import 'package:hyperio/uuid/uuid.dart';
...
class Hyperio {
  ...
  String getNativeLibraryPath({
    ...
    if (pathNativeLibrary.isEmpty) {
      return "libhyperio.${getLibraryExtension()}";
    }
  ...
  void ensureInitialized({
    ...
    final nativeCallback = Pointer.fromAddress(
      Hyperio._initializedNativeLibraryNativeCallbackFunction(
  ...
  Future<Map> invoke(Map parameters) async {
    ...
    final String extra = switch (parameters["@extra"]) {
      String value => value,
      Object() => "${client_id}_1754637243981_${generateUuidAzkadev(10)}",
      null => "${client_id}_1754637243981_${generateUuidAzkadev(10)}",
    };
