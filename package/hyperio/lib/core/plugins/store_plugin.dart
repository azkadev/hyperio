...
final storePluginData = <HyperioAzkadevHttpRequest, RequestStore>{};

/// Integrates [RequestStore] mechanism on [HttpRequest]
extension StorePlugin on HyperioAzkadevHttpRequest {
...
/// Used within [HyperioAzkadev] to remove request-related data after
