...
import 'package:hyperio/core/extensions/response_helpers.dart';
import 'package:hyperio/core/body_parser/body_parser.dart';
...
Future _respondWithFile(HyperioAzkadevHttpResponse res, File file,
...
extension _Logger on HyperioAzkadevHttpRequest {
  void log(String Function() msgFn) => hyperio.logWriter(
      () => 'DirectoryTypeHandler: ${msgFn()}', HyperioAzkadevLogType.debug);
  ...
  void preventTraversal(String filePath, Directory absDir) {
    ...
    if (!p.canonicalize(check.path).startsWith(absDirPath)) {
      ...
      throw HyperioAzkadevException(403, '403 forbidden');
    }
  }
}
