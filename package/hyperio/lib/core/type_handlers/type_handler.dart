...
class TypeHandler<T> {
  ...
  final FutureOr Function(
      HyperioAzkadevHttpRequest, HyperioAzkadevHttpResponse, T) _handler;

  /// HyperioAzkadevUncompleteDocumentation
  FutureOr handler(HyperioAzkadevHttpRequest req,
          HyperioAzkadevHttpResponse res, dynamic item) =>
